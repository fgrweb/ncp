<?php
/**
 * Updater from private GitHub repository
 *
 * @link       https://fgrweb.es
 * @since      1.0.0
 *
 * @package    v
 * @subpackage Ncp/updater
 */
...
define( 'GHPU_AUTH_TOKEN', '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' );
 ...
 * @since      1.0.0
 * @package    Ncp
 * @subpackage Ncp/includes
 * @author     Fernando García Rebolledo <info@fgrweb.es>
 */
class Ncp_Updater {
	private $file;
	private $plugin_data;
	 ...
	 * Construct function.
	 *
	 * @param  mixed $file The plugin file base.
	 * @return void
	 */
	...
	public function init(): void {
		add_action( 'pre_set_site_transient_update_plugins', array( $this, 'modify_transient' ), 10, 1 );
	...
	public function modify_transient( object $transient ): object {
		...
		if ( $transient->checked[$this->basename] ) {
